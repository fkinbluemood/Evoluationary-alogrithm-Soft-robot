...
f = open('C:/Users/18462/Desktop/ME/MECE 4510ea/ass3/3c/fitness_1.csv', 'w')
f_div = open('C:/Users/18462/Desktop/ME/MECE 4510ea/ass3/3c/diversity_1.csv', 'w')
f_pop=open('C:/Users/18462/Desktop/ME/MECE 4510ea/ass3/3c/centroids_1.csv', 'w')
f_shape=open('C:/Users/18462/Desktop/ME/MECE 4510ea/ass3/3c/shape_1.csv', 'w')
f_bestv=open('C:/Users/18462/Desktop/ME/MECE 4510ea/ass3/3c/best_vel_1.csv', 'w')
...
for i in range(num_evl):  # evolve shape for num_evl times
    ...
    for ith_centroid in new_pop:  # evolve centroids for num_eval times
        ...
        if count < num_pop:
            best_vel_cen, best_sample = evol_centroids_pop(ith_centroid, num_pop_cen, num_eval,  percent, materials_types)
        else:
            print('excute else')
            best_vel_cen, best_sample = evol_centroids_crossed(ith_centroid, num_pop_cen, num_eval, percent, materials_types)

        centroids_sel_vel.append(best_vel_cen)
        centroids_sel_pop.append(best_sample)
        vel_t.append(best_vel_cen)
        count += 1
    rank_vel, population = rank_selection(centroids_sel_pop, percent, centroids_sel_vel)

    current_best = rank_vel[0]

    if current_best > ini_best and current_best <10:
    ...
    elif current_best <= ini_best and current_best <10:
        fitness.append(ini_best)

    if i%5==0:
        diversity_value.append(diversity_shape(population))
...
xdiv = np.linspace(1, num_evl, int(num_evl/5))
print(diversity_value)

writer_d.writerow(diversity_value)
